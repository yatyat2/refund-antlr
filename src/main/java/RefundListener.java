...
public interface RefundListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link RefundParser#feeRate}.
	 * @param ctx the parse tree
	 */
	void enterFeeRate(RefundParser.FeeRateContext ctx);
	/**
	 * Exit a parse tree produced by {@link RefundParser#feeRate}.
	 * @param ctx the parse tree
	 */
	void exitFeeRate(RefundParser.FeeRateContext ctx);
	/**
