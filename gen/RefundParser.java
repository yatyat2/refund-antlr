...
public class RefundParser extends Parser {
	...
	public static final int
		...
		RULE_refundPrice = 8, RULE_sign = 9;
	private static String[] makeRuleNames() {
		return new String[] {
			"expression", "refundRule", "beginDate", "beginDDay", "endDate", "endDDay", 
			"dDay", "meetingOrder", "refundPrice", "sign"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, "PLUS", "MINUS", "NUMBER", 
			"WHITESPACE"
		};
	}
	...
	public static class ExpressionContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitExpression(this);
	...
	public static class RefundRuleContext extends ParserRuleContext {
		...
		public RefundPriceContext refundPrice() {
			return getRuleContext(RefundPriceContext.class,0);
		}
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitRefundRule(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BeginDateContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitBeginDate(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class BeginDDayContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitBeginDDay(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class EndDateContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitEndDate(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class EndDDayContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitEndDDay(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DDayContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitDDay(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MeetingOrderContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitMeetingOrder(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class RefundPriceContext extends ParserRuleContext {
		public TerminalNode NUMBER() { return getToken(RefundParser.NUMBER, 0); }
		public RefundPriceContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_refundPrice; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof RefundListener ) ((RefundListener)listener).enterRefundPrice(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof RefundListener ) ((RefundListener)listener).exitRefundPrice(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitRefundPrice(this);
			else return visitor.visitChildren(this);
		}
	}

	public final RefundPriceContext refundPrice() throws RecognitionException {
		RefundPriceContext _localctx = new RefundPriceContext(_ctx, getState());
		enterRule(_localctx, 16, RULE_refundPrice);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(71);
	...
	public static class SignContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof RefundVisitor ) return ((RefundVisitor<? extends T>)visitor).visitSign(this);
			else return visitor.visitChildren(this);
		}
	}
